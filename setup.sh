...
echo "    Super+p     — dmenu (launch apps)"
echo "    Super+s     — tmux directly"
echo "    Super+Shift+s → lazygit"
echo "    Super+l     — lf file manager"
echo "    Super+Shift+l → btop"
echo "    Super+Shift+r → restart dwm"
echo "    Super+1..9   — workspace (tag)"
echo "    Super+Shift+click tag → move window to that tag"
echo "    Super+Shift+q → quit dwm (returns to ly login)"
echo ""
echo "  Firefox (and Chrome/Chromium) always open on tag 9 (browser workspace)."
echo "  No bar, no borders — pure minimal look."
echo ""
