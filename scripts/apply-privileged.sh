...
sleep 0.2
nohup /etc/ly/dwm-statusbar >/tmp/statusbar.log 2>&1 & disown 2>/dev/null || nohup /home/blank/cachyOS-setup/configs/dwm/statusbar.sh >/tmp/statusbar.log 2>&1 & disown 2>/dev/null || true
sleep 0.3
